                ...
                decorationBox = @Composable { innerTextField ->
                    TextFieldDefaults.DecorationBox(
                        ...
                        colors = TextFieldDefaults.colors(
                            ...
                            unfocusedIndicatorColor =  if(enableIndicator) Grey999 else Color.Transparent,
                            focusedIndicatorColor = if(enableIndicator) colorResource(id = R.color.primary_1) else Color.Transparent ,
